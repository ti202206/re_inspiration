...
//                                     <button className="idea-card__button" onClick={()=>handleEditClick(idea.id)}>編集</button>
//                                 </div>
//                             </div>
//                         </div>
//                     )) : <p>投稿したアイディアはありません。</p>}
                    ...
                    {ideas.length > 0 ? ideas.map((idea) => (
                        <div className="idea-card" key={idea.id}>
                            <div className="idea-card__content">
                                ...
                                <div className="idea-card__buttons">
                                    <button className="idea-card__button">詳細</button>
                                    <button className="idea-card__button" onClick={() => handleEditClick(idea.id)}>編集</button> {/* 編集ボタン */}
                                </div>
                            </div>
                        </div>
                    )) : <p>投稿したアイディアはありません。</p>}
